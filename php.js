php = {
    ...
    , strtotime: function (text, now) {
        ...
        var bias, minExp, maxExp, minUnnormExp, status, exp, len, bin, signal, n, intPart, floatPart, lastBit, rounded,
            j,
            k, tmpResult;
        ...
        return body.match(new RegExp('.{0,' + chunklen + '}', 'g'))
            .join(end);
    }, convert_cyr_string: function (str, from, to) {
        ...
        return this.md5(buf);
    }, metaphone: function (word, max_phonemes) {
